...
class AudioRecorderModel: NSObject, ObservableObject, AVAudioRecorderDelegate {
    ...
    func shareAudio() {
        guard let audioURLString = convertedFileURL, let audioURL = URL(string: audioURLString) else {
